...
use archive::{
    ...
    validate_archive_payload_path, validate_imported_database, validate_project_archive,
...
pub(crate) fn project_summary_from_database(
    database: &Path,
    read_only: bool,
...
mod tests {
    ...
    use super::*;
    use crate::migrations::{MIGRATION_V1, apply_migration};
